...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> addUser(@RequestBody UserAddRequest request) { // Ubah jadi addUser
    ...
    public ResponseEntity<Map<String, Object>> getAllUsers() { // Ubah jadi getAllUsers
    ...
    public ResponseEntity<Map<String, Object>> updateUser( // Ubah jadi updateUser
    ...
    public ResponseEntity<Map<String, Object>> deleteUser(@PathVariable("id") String id) { // Ubah jadi deleteUser
